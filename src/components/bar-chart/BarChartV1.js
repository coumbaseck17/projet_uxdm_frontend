...
export default {
    ...
    methods: {
        ...
        getDetailData() {
            // Retournez les données appropriées pour le graphique de détail
            // Par exemple, les données liées à la barre sélectionnée
            return [10, 20, 30]; // Remplacez cela par vos données réelles
        },
    },
};
